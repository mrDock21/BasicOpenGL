...
ifdef targetFile
	echo 'TARGET_FILE=${targetFile}'
endif
ifdef targetFolder
	echo 'TARGET_FOLDER=${targetFolder}'
endif

${buildFolder}/${targetFile}: window.o Shader.o Texture.o Mesh.o element_buffer.o vertex_buffer.o camera.o input.o material.o transform.o ${targetFile}.o
	echo 'Linking obj files'
	#link all compiled objects
	g++ ${targetFile}.o ${objFolder}/window.o ${objFolder}/Shader.o ${objFolder}/Texture.o ${objFolder}/Mesh.o ${objFolder}/element_buffer.o ${objFolder}/vertex_buffer.o ${objFolder}/camera.o ${objFolder}/input.o ${objFolder}/material.o ${objFolder}/transform.o -o ${buildFolder}/${targetFile}
...
window.o: window.cpp
	...
	g++ -Wall ${glfwLibs} -I${includeFolder} -c ${srcFolder}/window.cpp -o ${objFolder}/window.o

Shader.o: Shader.cpp
	echo 'Compilling => Shader.cpp'
	g++ -Wall ${glfwLibs} -I${includeFolder} -c ${srcFolder}/Shader.cpp -o ${objFolder}/Shader.o

Texture.o: Texture.cpp
	echo 'Compilling => Texture.cpp'
	g++ -Wall ${glfwLibs} -I${includeFolder} -c ${srcFolder}/Texture.cpp -o ${objFolder}/Texture.o
...
element_buffer.o: vertex_buffer.o element_buffer.cpp
	...
	g++ -Wall ${glfwLibs} -I${includeFolder} -c ${srcFolder}/element_buffer.cpp -o ${objFolder}/element_buffer.o

vertex_buffer.o: vertex_buffer.cpp
	echo 'Compilling => vertex_buffer.cpp'
	g++ -Wall ${glfwLibs} -I${includeFolder} -c ${srcFolder}/vertex_buffer.cpp -o ${objFolder}/vertex_buffer.o
...
input.o: input.cpp
	...
	g++ -Wall ${glfwLibs} -I${includeFolder} -c ${srcFolder}/input.cpp -o ${objFolder}/input.o
